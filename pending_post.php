...
<div class="main-content">
  ...
  <?php
      ...
      $query="SELECT * FROM job_post WHERE job_status='pending'";
  ...
  <tr>
    ...
    <td>
      <a type="button" style="border-style:none; padding:5px;background-color:red;color:#fff" href="reject_post.php?job_id=<?php echo $job_id;?>">Reject</a>
      <a type="button" style="border-style:none; padding:5px;background-color:green;color:#fff" href="approve_post.php?job_id=<?php echo $job_id;?>">Approve</a>
    </td>
  </tr>
  <?php
      }
