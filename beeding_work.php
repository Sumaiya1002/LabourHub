...
<table>
  ...
  <tr>
    ...
    <td>
      <a type="button" style="border-style:none; padding:5px;background-color:green;color:#fff" href="confirm_work.php?claimed_id=<?php echo $claimed_id;?>&client_id=<?php echo $client_id;?>">Approve</a>
    </td>
  </tr>
  <?php
        }
