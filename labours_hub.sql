...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2020 at 06:31 PM
...
(3, 'Clean Car', 'iuskghwrkbsgiwkegbnvwekgnkwegnkwejgndwedf', '2020-05-28', '12/a', 'monthly', '10000', 'approved', 1, 4),
(4, 'Fix the pipe', 'owehsdognwsdkvnwdsvkn', '2020-05-28', '12/D', 'yearly', '10000', 'approved', 1, 6);
...
--
ALTER TABLE `claimed`
  MODIFY `claimed_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
